          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="space-y-3">
                ...
                {data.data.penandatangan?.dewanMasyayikh && (
                  <div className="flex items-start gap-3 p-3 bg-amber-50 rounded-lg">
                    <CheckBadgeIcon className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
                    <div>
                      <p className="text-sm font-semibold text-gray-800">{data.data.penandatangan.dewanMasyayikh.nama}</p>
                      <p className="text-xs text-gray-500">{data.data.penandatangan.dewanMasyayikh.jabatan}</p>
                      <p className="text-xs text-amber-600 mt-0.5">
                        ✓ Mengetahui: {formatDateTime(data.data.penandatangan.dewanMasyayikh.tanggalTtd)}
                      </p>
                    </div>
                  </div>
                )}
